...
class ProductItem(models.Model):
    ...
    product_id = models.CharField(max_length=128, unique=True, verbose_name='Product ID')
    product_weight = models.CharField(max_length=128, unique=True, verbose_name='Product Weight')
